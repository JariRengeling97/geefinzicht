<section class="recent-experts py-5 xl:py-10">
  <div class="container">
    <div class="xl:flex xl:items-center">
      <div>
        <h2 class="text-2xl lg:text-3xl font-semibold">Nieuwste aangesloten experts</h2>
      ...
      <div class="hidden xl:inline-block text-right w-full">
        <a href="" class="py-2.5 px-12 bg-primary border-primary border-2 rounded-md text-white inline-block font-semibold hover:bg-transparent hover:text-primary transition-all">Alle experts bekijken 
    ...
    <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:grid-cols-3">
      @include('components.expert-card')
      @include('components.expert-card')
      @include('components.expert-card')
    </div>
  </div>
