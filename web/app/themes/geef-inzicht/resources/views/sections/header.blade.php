    ...
    <div class="flex justify-between items-center">
      ...
      <div class="hidden lg:block">
        <div class="flex items-center">
          ...
          <div>
            <a href="/expert-worden" class="py-2.5 px-12 bg-primary border-primary border-2 rounded-md text-white inline-block font-semibold hover:bg-transparent hover:text-primary transition-all">Expert worden 
