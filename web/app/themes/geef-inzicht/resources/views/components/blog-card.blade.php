<div class="object-cover overflow-hidden object-center pt-2 lg:pt-4">
  <img src="/app/uploads/2022/11/pexels-daniel-xavier-1239291-scaled.jpg" class="h-60 w-full object-cover rounded-md">
  <div class="flex justify-between items-center mt-3">
    <div>
      <h3 class="text-xl lg:text-2xl mb-0">John Doe</h3>
    </div>
    <div>
